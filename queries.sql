...
joins_exercise=# SELECT first_name,last_name,COUNT(*) FROM owners o JOIN vehicles v
ON o.id = v.owner_id GROUP BY o.first_name,o.last_name ORDER BY o.first_name;
/*
...
joins_exercise=# SELECT first_name,last_name,ROUND(SUM(price)/COUNT(*)) AS average_price,COUNT(*) FROM owners o
JOIN vehicles v
ON o.id = v.owner_id 
GROUP BY o.first_name,o.last_name HAVING COUNT(*)>1 AND SUM(price)/COUNT(*)>10000 
